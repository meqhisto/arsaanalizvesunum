"""Add office_id to arsa_analizleri

Revision ID: 5ea8552e7f56
Revises: 
Create Date: 2025-05-19 01:14:36.123010
...
def upgrade():
    ...
    op.add_column('arsa_analizleri', sa.Column('office_id', sa.Integer(), nullable=True))
    ...
    op.create_foreign_key(None, 'arsa_analizleri', 'offices', ['office_id'], ['id'], ondelete='SET NULL')
    ...
    op.add_column('crm_contacts', sa.Column('office_id', sa.Integer(), nullable=True))
    ...
    op.add_column('crm_deals', sa.Column('office_id', sa.Integer(), nullable=True))
    ...
    op.add_column('crm_tasks', sa.Column('office_id', sa.Integer(), nullable=True))
    ...
    op.create_foreign_key(None, 'crm_tasks', 'offices', ['office_id'], ['id'])
...
def downgrade():
    ...
    op.alter_column('crm_tasks', 'recurrence_type',
               ...
               existing_nullable=True)
    op.drop_column('crm_tasks', 'office_id')
    ...
    op.drop_column('crm_deals', 'office_id')
    ...
    op.drop_column('crm_contacts', 'office_id')
    ...
    op.alter_column('bolge_dagilimi', 'user_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.drop_constraint(None, 'arsa_analizleri', type_='foreignkey')
    ...
    op.drop_column('arsa_analizleri', 'office_id')
